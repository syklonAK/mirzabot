...
function self_update_script() {
    ...
    local URL="https://raw.githubusercontent.com/syklonAK/mirzabot/main/install.sh"
...
function migrate_to_pro() {
    ...
    rm -rf "$OLD_BOT_DIR"
    mkdir -p "$NEW_BOT_DIR"
    ZIP_URL="https://github.com/syklonAK/mirzabot/archive/refs/heads/main.zip"
